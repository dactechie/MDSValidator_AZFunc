...
def ArcadiaDay_json_validator():
  validator = get_validator_for_program('ArcadiaDay')
  return validator
...
def test_tds_good(ArcadiaDay_json_validator):
        ...
        errors, _ = ArcadiaDay_json_validator.validate({'episodes' :[base4error]})
        assert errors[0] == []



def test_jailoutreach_mttallowed(ArcadiaDay_json_validator):
        ...
        errors, _ = ArcadiaDay_json_validator.validate({'episodes' :[base0error, base1error]})
